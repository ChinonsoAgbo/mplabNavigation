...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rotateAndCompass() // sets and draws the compass and enables rotation
    ...
    /**
     * Function to set up rotation gesture and compass overlay on a MapView.
     * This function initializes a CompassOverlay and a RotationGestureOverlay,
     * and adds them to the specified MapView ( map ) .
     */
    private fun rotateAndCompass(){
        // Create a CompassOverlay with a custom draw method to handle compass rotation
        val mapCompassOverlay =object:CompassOverlay(this,map){
            /**
             * Override the draw method to add custom compass rotation logic.
             * Calls the super class draw method and then draws the compass based on map orientation.
             *
             * @param c Canvas to draw on.
             * @param pProjection Projection for the map.
             */
        ...
        // Create a RotationGestureOverlay for handling rotation gestures
        val rotationGestureOverlay = RotationGestureOverlay(this,map )
        rotationGestureOverlay.isEnabled = true
        // Enable multi-touch controls on the map
        map.setMultiTouchControls(true)
        // Add the RotationGestureOverlay and CompassOverlay to the map overlays
        map.overlays.add(rotationGestureOverlay)
        map.overlays.add(mapCompassOverlay)
    }
